...
- 创建 `sessions/2026-05-13-香火钱口播闭环测试/`
- 写入 `README.md`、`调用记录.md`、`终稿.md`
- 将成品暂存到 `output/文案/2026-05-14-香火钱口播闭环测试-终稿.md`
- 将长期项目资产回链到 `10-项目/道物天成/内容资产/选题库/闭环测试/2026-05-14-香火钱口播闭环测试-终稿.md`
...
- 道物天成项目内存在多个“香火钱”版本，后续需要建立主稿/旧稿/测试稿的版本命名规则。
...
- 明确内容生产过程写入 `sessions/`，成品写入 `output/`，长期资产需回链到 `10-项目/道物天成/内容资产/`。
